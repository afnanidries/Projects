...
//        System.out.println("JSON payload: " + TestUtils.asJsonString(r1));
        ...
        Assertions.assertEquals(1, service.findAll().size(), "One recipe should have been added");
    ...
    public void testCreateRecipe () throws Exception {
        ...
        recipeNoIngredients.setPrice( 100.0 );
    ...
    private Recipe createRecipe ( final String name, final double price, final Integer coffee, final Integer milk,
